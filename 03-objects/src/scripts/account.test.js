...
test('does the isNewAcc function work?', () => {
    ...
    expect(control5.isNewAccount('Chequing')).toEqual(undefined);
    expect(control5.isNewAccount('Savings')).toEqual(undefined);
...
test('does the isNewAmmount function work?', () => {
    ...
    expect(control6.isNewAmount('C')).toEqual(undefined);
});